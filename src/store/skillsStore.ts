...
const MOCK_HARD_SKILLS: HardSkill[] = [
  {
    id: 'hs-1', profileId: 'mock-profile', level: 'Senior', isTop: true, topOrder: 1,
    skillTag: { id: 'tag-react', name: 'React', category: 'Frontend', isNormalized: true },
    endorsements: [], createdAt: '2024-01-10T00:00:00Z',
  },
  {
    id: 'hs-2', profileId: 'mock-profile', level: 'Senior', isTop: true, topOrder: 2,
  ...
  {
    id: 'hs-3', profileId: 'mock-profile', level: 'Mid', isTop: false,
    skillTag: { id: 'tag-nextjs', name: 'Next.js', category: 'Frontend', isNormalized: true },
    endorsements: [], createdAt: '2024-01-12T00:00:00Z',
  },
  {
    id: 'hs-4', profileId: 'mock-profile', level: 'Senior', isTop: true, topOrder: 3,
...
const MOCK_SOFT_SKILLS: SoftSkill[] = [
  {
    id: 'ss-1', profileId: 'mock-profile',
  ...
  {
    id: 'ss-2', profileId: 'mock-profile',
  ...
  {
    id: 'ss-3', profileId: 'mock-profile',
  ...
  {
    id: 'ss-4', profileId: 'mock-profile',

...
const resources = {
  es: {
    translation: {
      ...
      'settings.githubHeatmap': 'Heatmap de GitHub',
      'settings.githubConnect': 'Conectar con GitHub',
      'settings.language': 'Idioma de la interfaz',
      'settings.languageDesc': 'Elige el idioma en que se muestra EthosHub.',
      'settings.showEmail': 'Mostrar email',
  ...
  en: {
    translation: {
      ...
      'settings.githubHeatmap': 'GitHub Heatmap',
      'settings.githubConnect': 'Connect with GitHub',
      'settings.language': 'Interface Language',
      'settings.languageDesc': 'Choose the language EthosHub is displayed in.',
  ...
  pt: {
    translation: {
      ...
      'auth.email': 'E-mail',
      'auth.password': 'Senha',
      'auth.selectRole': 'Selecionar papel para demo',
      ...
      'skills.searchPlaceholder': 'Buscar habilidade...',
      'skills.selectLevel': 'Selecionar nível',
      'skills.junior': 'Junior',
      'skills.mid': 'Mid',
      'skills.senior': 'Senior',
      'skills.endorsements': 'validações',
      'skills.endorse': 'Validar',
      'skills.endorsed': 'Validado',
      'skills.maxTopSkills': 'Máximo de 3 top skills permitidas',
      'skills.createTag': 'Criar nova etiqueta',
      ...
      'projects.projectTitle': 'Título do projeto',
      ...
      'projects.technicalInfo': 'Informações técnicas',
      'projects.role': 'Papel desempenhado',
      'projects.technologies': 'Tecnologias',
      'projects.startDate': 'Data de início',
      'projects.endDate': 'Data de término',
      'projects.results': 'Resultados',
      'projects.media': 'Mídia',
      ...
      'connections.disconnected': 'Desconectado',
      'connections.expired': 'Expirado',
      'connections.syncAll': 'Sincronizar tudo',
      'connections.disconnect': 'Desconectar',
      'connections.reconnect': 'Reconectar',
      'connections.lastSync': 'Última sincronização',
      'connections.github': 'GitHub',
      'connections.linkedin': 'LinkedIn',
      'connections.repositories': 'Repositórios',
      'connections.import': 'Importar',
      'connections.imported': 'Importado',
      ...
      'visibility.taken': 'Já em uso',
      'visibility.reserved': 'Reservado pelo sistema',
      'visibility.sections': 'Visibilidade por seção',
      'visibility.public': 'Público',
      'visibility.linkOnly': 'Somente com link',
      'visibility.private': 'Privado',
      'visibility.seo': 'Metadados SEO',
      'visibility.seoTitle': 'Título SEO',
      'visibility.seoDescription': 'Descrição SEO',
      'visibility.preview': 'Pré-visualização',
      ...
      'analytics.totalPortfolios': 'Total de portfólios',
      'analytics.totalVisits': 'Total de visitas',
      'analytics.recentActivity': 'Atividade recente',
      'analytics.noData': 'Não há dados suficientes para monitorar o comportamento geral da plataforma',
      ...
      'settings.githubHeatmap': 'Heatmap do GitHub',
      'settings.githubConnect': 'Conectar com GitHub',
      'settings.language': 'Idioma da interface',
      'settings.languageDesc': 'Escolha o idioma em que o EthosHub é exibido.',
      'settings.showEmail': 'Mostrar email',
